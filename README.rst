...
Run
=============
To run this project you have to execute the commands below in the terminal:
* `1- cd google_images_download/google_images_download/`__
* `2- python3 google_images_download.py -kf 'keyword1.txt' -cd /usr/bin -l 150`__
